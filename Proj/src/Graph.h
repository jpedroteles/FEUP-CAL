...
class Graph {
	...
	void branchAndBound(list<Vertex<T>*> &best, int &bestDist,
			list<Vertex<T>*> &current, int dist);
...
template<class T>
void Graph<T>::branchAndBound(list<Vertex<T>*> &best, int &bestDist,
		list<Vertex<T>*> &current, int dist) {
